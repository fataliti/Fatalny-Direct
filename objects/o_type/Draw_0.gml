...
color(c_white);
alpha(1);
draw_text(x+5, y+5, string_trim("Type: "+typeNames[type], _xp-15));

if see {
	color($181113);
	draw_rectangle(x, y+24, x+_xp, y+24+100,false);
	color(c_white);
	var inc = 30;
	for (var a = 0; a < array_length(typeNames); a++) {
		var c = type == a ? selectedColor : c_white;
...
if !mouseIn_mf0 x mouseIn_mf1  y mouseIn_mf2  x+_xp mouseIn_mf3  y+24 +100 mouseIn_mf4 
	see = false;